...
# Process the MaxQuant results of the cdc55 delta experiment
if __name__ == '__main__':
    root = '../'
    table_dir = os.path.join(root, 'tables')
    fasta_path = os.path.join(root, 'yeast_cont_20140324.fasta')
    mq_txt_folder = 'MQ_txt_cdc55D'
    evidence_path = os.path.join(
        root, 'MaxQuant', mq_txt_folder, 'evidence.txt'
    )
    experiments_toreverse = ['01_cdc55', '04_cdc55', '07_cdc55', 'B_cdc55',
                             'D_cdc55', 'E_cdc55', 'G_cdc55', 'J_cdc55']
    setup = 'cdc55D'
